...
# Isto é essencial para que o seu 'codigo(2).html' possa fazer requisições para esta API.
...
# =======================================================================
# NOVA ROTA PARA SINCRONIZAÇÃO
# =======================================================================
# Esta rota é uma cópia da rota /api/cadastros, mas retorna todos os campos
# para que o código (2) possa preencher o formulário.
...
def get_cadastros_sinc(current_user):
    ...
    for c in cadastros:
        ...
        # Formata as datas para o formato ISO para evitar problemas no JSON
